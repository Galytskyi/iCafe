...
//	QLabel*	item01Label = new QLabel(tr("- Да того чтобы забронировать столик закак"), this);
//	QLabel*	item02Label = new QLabel(tr("- Да того чтобы забронировать столик закак"), this);
//	QLabel*	item03Label = new QLabel(tr("- Да того чтобы забронировать столик закак"), this);

//	faqLayout->addWidget(item01Label);
//	faqLayout->addWidget(item02Label);
//	faqLayout->addWidget(item03Label);
	...
	//mainLayout->addLayout(faqLayout);
